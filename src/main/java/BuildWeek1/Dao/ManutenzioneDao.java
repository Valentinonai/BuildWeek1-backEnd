...
public class ManutenzioneDao {
    ...
    public Manutenzione getManutenzioneNull(long mezzo_id) {
        TypedQuery<Manutenzione> q = em.createQuery("SELECT m FROM Manutenzione m WHERE m.dataFine=null AND m.mezzo.id = :mezzo_id", Manutenzione.class);
