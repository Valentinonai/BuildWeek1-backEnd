                    ...
                    try {
                        ...
                        switch (risp) {
                            case 1 -> {
                                ...
                                LocalDate dataI = LocalDate.of(annoi, mesei, giornoi);
                                LocalDate dataF = LocalDate.of(annof, mesef, giornof);
                                if (dataI.isBefore(dataF)) {
                                    List<Object[]> ticketRange = ticketDao.getTotalTicketInTimeRangeGroupedByType(dataI, dataF);
                                ...
                                } else throw new Exception("La data iniziale deve essere antecedente alla data finale");
                            }
                            case 2 -> {
                                        ...
                                        switch (r) {
                                            case 1 -> {
                                                if (!m.isInManutenzione() && !m.isInServizio()) {
                                                    m.setInServizio(id_m, true, em, 0);
                                                } else throw new Exception("Mezzo già in servizio o in manutenzione");
                                            }
                                            case 2 -> {
                                                if (!m.isInManutenzione() && !m.isInServizio()) {
                                                    m.setInManutenzione(id_m, true, em, 0);
                                                } else throw new Exception("Mezzo già in servizio o in manutenzione");
                                            }
                                            case 3 -> {
                                                if (!m.isInManutenzione() && m.isInServizio()) {
                                                    m.setInServizio(id_m, false, em, rnd.nextInt(1, 10));
                                                } else throw new Exception("Mezzo non in servizio o in manutenzione");
                                            }
                                            case 4 -> {
                                                if (m.isInManutenzione() && !m.isInServizio()) {
                                                    m.setInManutenzione(id_m, false, em, rnd.nextInt(1, 10));
                                                } else throw new Exception("Mezzo non in servizio o in manutenzione");
                                            }
                                        }
                            ...
                            case 14 -> {
                                ...
                                System.out.println("Inserisci giorno data finale");
                                int giornof = Integer.parseInt(scanner.nextLine());
                                LocalDateTime dataI = LocalDate.of(annoi, mesei, giornoi).atStartOfDay();
                                LocalDateTime dataF = LocalDate.of(annof, mesef, giornof).atStartOfDay();
                                if (dataI.isBefore(dataF)) {
                                    long num_ticket = ticketDao.getTicketByMezzo(mezzo_id, dataI, dataF);
